...
![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671169726559-7fb622a4-7ffb-4421-9fec-86e04926b296.png)

查看漏洞修复补丁，其中对 token 的数据类型继续校验，需要为字符串才能通过代码

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671170956754-84491a05-7bef-4dac-8b5e-9244efa4d7f4.png)

来到代码块中，首先先从请求中获取 token 数据，通过校验后来到方法` parseToken`

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671171392904-ec4b2f8c-3560-4ab1-85b8-c6c53e5c1886.png)

`server/utils/token.js#parseToken` 方法中对 token进行解密，当解密失败时返回 False

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671171615851-df84a9ba-26e6-40b7-b04c-e0661395fecc.png)

在这个文件中我们可以找到 Token的加解密方法

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671171648530-49b0650b-c738-46c4-a19e-396aaa0125f2.png)

Token为False时，代码走向 `server/controllers/base.js#getProjectIdByToken`方法

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671171978786-6965ebdc-bc50-4323-a486-1d5b4230b9b0.png)

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671175628918-906a871d-cfd7-40c0-a5b0-033485945e72.png)

getProjectIdByToken方法调用 `server/models/token.js#findId `方法

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671175690677-5aad9d1b-d6ef-499c-a797-19729ded9b5b.png)使用 $regex 关键字匹配MongoDB 数据库中的 token, 并通过页面回显判断 token是否正确

```php
db.token.findOne({token:{'$regex':'^1c'}})
```

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671178473758-95a3459a-899a-4b36-972d-c8f5279e69b8.png)
...
![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671178679701-74a62f84-0216-4f5e-acc3-44ef42ebbbc3.png)

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671178691191-dcd8d4b1-9972-4205-80a1-5138ecd811c1.png)

![img](https://security-1310978225.cos.ap-beijing.myqcloud.com/public/img/1671178776347-fcd745c6-f3f1-43a7-97e8-2ad68b9d0f0b.png)
